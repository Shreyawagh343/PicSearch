  ...
  return (
    <div className="md:flex pb-[3rem] md:p-[0rem] pt-[1rem] mt-[3rem] md:mt-[3rem] md:bg-[#f5ebe0]">
      ...
      >
        ...
        <p className="text-center mt-[1rem] text-[1.3rem] md:text-[1.4rem]">
          "Looking for fresh ideas? Explore endless creativity, from stunning
          home decor to DIY projects. Try searching for ‘creative ideas for home
          decor’ and uncover inspiration to transform your space!"{" "}
        </p>
      </motion.div>
      <motion.div
